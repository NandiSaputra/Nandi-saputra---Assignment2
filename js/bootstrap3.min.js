/* ! Bootstrap v3.4.1 (https://getbootstrap.com/) Copyright 2011-2019 Twitter,
...
function (p) {
    ...
    var c = function (t, e) {
        ...
        this.options.keyboard && this
            .$element
            .on("keydown.bs.carousel", p.proxy(this.keydown, this)),
    ...
    c.prototype.slide = function (t, e) {
        ...
        if (this.$element.trigger(l), !l.isDefaultPrevented()) {
            ...
            return p.support.transition && this
                .$element
                .hasClass("slide")
                    ? (
                        o.addClass(t),
...
function (a) {
    ...
    function n(t) {
        var e,
            i = t.attr("data-target") || (e = t.attr("href")) && e.replace(
                /.*(?=#[^\s]+$)/,
                ""
            );
...
function (a) {
    ...
    function l(t) {
        ...
        e || (
            e = (e = t.attr("href")) && /#[A-Za-z]/.test(e) && e.replace(/.*(?=#[^\s]*$)/, "")
        );
        var i = "#" !== e
            ? a(document).find(e)
            : null;
    ...
    function s(o) {
        o && 3 === o.which || (
            ...
            a(r).each(function () {
                ...
                e.hasClass("open") && (
                    o && "click" == o.type && /input|textarea/i.test(o.target.tagName) && a.contains(e[0], o.target) || (e.trigger(o = a.Event("hide.bs.dropdown", i)), o.isDefaultPrevented() || (
...
function (a) {
    ...
    s.prototype.escape = function () {
        this.isShown && this.options.keyboard
            ? this
                .$element
                .on("keydown.dismiss.bs.modal", a.proxy(function (t) {
...
function (g) {
    ...
    function u(t, e) {
        var i = t
            ...
            .toLowerCase();
        if (-1 !== g.inArray(i, e)) 
            return -1 === g.inArray(i, a) || Boolean(
                t.nodeValue.match(r) || t.nodeValue.match(l)
            );
    ...
    m.prototype.init = function (t, e, i) {
        if (
            ...
            this.$viewport = this.options.viewport && g(document).find(
        ...
        for (var o = this.options.trigger.split(" "), n = o.length; n--;) {
            ...
            if ("click" == s) 
                this
                    .$element
                    .on("click." + this.type, this.options.selector, g.proxy(this.toggle, this));
            else if ("manual" != s) {
                var a = "hover" == s
                        ? "mouseenter"
                        : "focusin",
                ...
                this
                    .$element
                    .on(a + "." + this.type, this.options.selector, g.proxy(this.enter, this)),
                this
                    .$element
    ...
    m.prototype.getOptions = function (t) {
        ...
        return (t = g.extend({}, this.getDefaults(), e, t)).delay && "number" == typeof t.delay && (
            t.delay = {
                show: t.delay,
                hide: t.delay
            }
    ...
    m.prototype.enter = function (t) {
        ...
        if (e || (
            ...
            g(t.currentTarget).data(
                "bs." + this.type,
                e
            )
        ), t instanceof g.Event && (e.inState[
            "focusin" == t.type
                ? "focus"
                : "hover"
        ] = !0), e.tip().hasClass("in") || "in" == e.hoverState) 
            e.hoverState = "in";
        else {
            if (
    ...
    m.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (r) {
                ...
                s = "bottom" == s && l.bottom + d > c.bottom
                    ? "top"
                    : "top" == s && l.top - d < c.top
                        ? "bottom"
            ...
            var u = function () {
                ...
                i
                    .$element
                    .trigger("shown.bs." + i.type),
                i.hoverState = null,
                "out" == t && i.leave(i)
            };
            g.support.transition && this
                .$tip
                .hasClass("fade")
                    ? o
    ...
    m.prototype.toggle = function (t) {
        var e = this;
        t && ((e = g(t.currentTarget).data("bs." + this.type)) || (
            e = new this.constructor(t.currentTarget, this.getDelegateOptions()),
            g(t.currentTarget).data(
                "bs." + this.type,
                e
...
function (n) {
    ...
    (
        (s.prototype = n.extend({}, n.fn.tooltip.Constructor.prototype)).constructor = s
...
function (s) {
    ...
    function n(t, e) {
        ...
        this
            .$scrollElement
            .on("scroll.bs.scrollspy", s.proxy(this.process, this)),
        this.refresh(),
        this.process()
    }
    function e(o) {
    ...
    n.prototype.process = function () {
        ...
        if (a && e < n[0]) 
            ...
            this.clear();
        for (t = n.length; t--;) 
            a != s[t] && e >= n[t] && (n[t + 1] === undefined || e < n[t + 1]) && this.activate(
                s[t]
            )
    },
    n.prototype.activate = function (t) {
        this.activeTarget = t,
        this.clear();
        var e = this.selector + '[data-target="' + t + '"],' + this.selector +
                    '[href="' + t + '"]',
            i = s(e)
                .parents("li")
                .addClass("active");
...
function (l) {
    ...
    var h = function (t, e) {
        ...
        var i = this.options.target === h.DEFAULTS.target
